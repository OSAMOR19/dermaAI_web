...
const testimonials = [
  ...
  { name: 'Fatima A.', role: 'Dermatology Student, Edinburgh', quote: "From a professional perspective, the accuracy of their skin analysis is impressive. It identified texture issues I hadn't noticed.", stars: 5, avatar: '/avatar-1.png' },
